...
SECRET_KEY = 's)=$%4of4=(nv(cii80*3z=ot50yhwstph6d9d#&ohz0+3f6!b'
...
WEBPACK_LOADER = {
    'DEFAULT': {
        ...
        'STATS_FILE': os.path.join(BASE_DIR2, '../webpack-stats.json'),
        'POLL_INTERVAL': 0.1,
        'TIMEOUT': None,
...
STATICFILES_DIRS = os.path.join(BASE_DIR2, 'books/static/')
...
#TEMPLATE_URL = 'books/barcode-app-master/'
