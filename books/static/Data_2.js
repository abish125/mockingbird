...
function create_bmp() {
  var bmp =  {sodium: random_number(3.5,4.5), potassium: random_number(3.5,5), chloride: random_number(96,106), 
    bicarb: random_number(22,29), bun: random_number(7,20), 
    creatinine: random_number(0.6, 1.2), glucose: random_number(70,100)}

  return bmp
}

function create_patient_bmp_data(num_elements) {

    var bmps = new Array;

    for (var element=0; element<num_elements; element++) {
        bmps[element] = {"timestamp":element, "val" : create_bmp()};
    }

    return (bmps);
};

console.log(create_patient_bmp_data(2))
...
var Data = [{
       ...
       bmp_data: create_patient_bmp_data(4),
